...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
    ...
    "enterPartyName": MessageLookupByLibrary.simpleMessage(
      "Внесете име на партијата",
    ),
    "enterPhoneNumber": MessageLookupByLibrary.simpleMessage(
      "Внесете број на телефон",
    ),
    ...
    "sendWhatsappMessage": MessageLookupByLibrary.simpleMessage(
      "Испрати порака на whatsapp",
    ),
    "sendYOurEmail": MessageLookupByLibrary.simpleMessage(
      "Испратете го вашиот е-маил",
    ),
    ...
    "theExcelFileHasAlreadyBeenDownloaded":
        MessageLookupByLibrary.simpleMessage("Excel фајлот веќе е преземен"),
