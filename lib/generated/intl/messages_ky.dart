...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
    ...
    "createdAndSaved": MessageLookupByLibrary.simpleMessage(
      "Түзүлдү жана сакталды",
    ),
    "currency": MessageLookupByLibrary.simpleMessage("Валюта"),
    "currentStock": MessageLookupByLibrary.simpleMessage(
      "Учурдагы инвентаризация",
    ),
    ...
    "payeeName": MessageLookupByLibrary.simpleMessage(
      "Төлөм алган адамдын аты",
    ),
    "payeeNumber": MessageLookupByLibrary.simpleMessage(
      "Төлөм алган адамдын номер",
    ),
    ...
    "pleaseEnterName": MessageLookupByLibrary.simpleMessage(
      "Сураныч, атын киргизиңиз",
    ),
    "pleaseEnterPassword": MessageLookupByLibrary.simpleMessage(
      "Сураныч, паролду киргизиңиз",
    ),
    "pleaseEnterTheEmailAddressBelowToRecive": MessageLookupByLibrary.simpleMessage(
    ...
    "purchaseConfirmed": MessageLookupByLibrary.simpleMessage(
      "Сатып алуу тастыкталды",
    ),
    "purchaseDetails": MessageLookupByLibrary.simpleMessage(
      "Сатып алуу тууралуу маалымат",
    ),
    "purchaseInvoice": MessageLookupByLibrary.simpleMessage(
      "Сатып алуу фактурасы",
    ),
    ...
    "recentTransactions": MessageLookupByLibrary.simpleMessage(
      "Жакындагы Транзакциялар",
    ),
    "recivedThePin": MessageLookupByLibrary.simpleMessage(
      "PIN номерин кабыл алды",
    ),
