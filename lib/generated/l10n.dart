...
class S {
  ...
  /// `Orders`
  String get order {
    return Intl.message('Orders', name: 'order', desc: '', args: []);
  }
  ...
  /// `Close`
  String get otp {
    return Intl.message('Close', name: 'otp', desc: '', args: []);
  }
  ...
  /// `Get Otp`
  String get getOtp {
    return Intl.message('Get Otp', name: 'getOtp', desc: '', args: []);
  }
  ...
  String get verifyOtp {
    return Intl.message('Verifying OTP', name: 'verifyOtp', desc: '', args: []);
  }
  ...
  String get wholSeller {
    return Intl.message('Wholesaler', name: 'wholSeller', desc: '', args: []);
  }
  ...
  /// `Cancel`
  String get cacel {
    return Intl.message('Cancel', name: 'cacel', desc: '', args: []);
  }
  ...
  /// `Supplier`
  String get upplier {
    return Intl.message('Supplier', name: 'upplier', desc: '', args: []);
  }
  ...
  String get addDescription {
    return Intl.message('Add note', name: 'addDescription', desc: '', args: []);
  }
  ...
  /// `From Date`
  String get formDate {
    return Intl.message('From Date', name: 'formDate', desc: '', args: []);
  }
  ...
  /// `Maan`
  String get maan {
    return Intl.message('Maan', name: 'maan', desc: '', args: []);
  }

  /// `Package`
  String get pacakge {
    return Intl.message('Package', name: 'pacakge', desc: '', args: []);
  }
  ...
  /// `Facebook`
  String get facebok {
    return Intl.message('Facebook', name: 'facebok', desc: '', args: []);
  }
  ...
  String get instragram {
    return Intl.message('Instagram', name: 'instragram', desc: '', args: []);
  }
  ...
  String get inistrument {
    return Intl.message('Instrument', name: 'inistrument', desc: '', args: []);
  }
  ...
  /// `Inv No.`
  String get invNo {
    return Intl.message('Inv No.', name: 'invNo', desc: '', args: []);
  }
  ...
  /// `Total: `
  String get totals {
    return Intl.message('Total: ', name: 'totals', desc: '', args: []);
  }
  ...
  String get saleReports {
    return Intl.message('Sale Report', name: 'saleReports', desc: '', args: []);
  }

  /// `Due Report`
  String get dueReports {
    return Intl.message('Due Report', name: 'dueReports', desc: '', args: []);
  }
  ...
  /// `Send sms?`
  String get sendSmsw {
    return Intl.message('Send sms?', name: 'sendSmsw', desc: '', args: []);
  }
  ...
  String get payeeName {
    return Intl.message('Payee Name', name: 'payeeName', desc: '', args: []);
  }
  ...
  /// `Font Side`
  String get fontSide {
    return Intl.message('Font Side', name: 'fontSide', desc: '', args: []);
  }
  ...
  String get totalStock {
    return Intl.message('Total Stocks', name: 'totalStock', desc: '', args: []);
  }

  /// `Use Pos Saas`
  String get useMobiPos {
    return Intl.message('Use Pos Saas', name: 'useMobiPos', desc: '', args: []);
  }
  ...
  /// `POS SAAS`
  String get POSsAAS {
    return Intl.message('POS SAAS', name: 'POSsAAS', desc: '', args: []);
  }
  ...
  String get oTPSentTo {
    return Intl.message('OTP sent to', name: 'oTPSentTo', desc: '', args: []);
  }
  ...
  /// `Party GST`
  String get partyGST {
    return Intl.message('Party GST', name: 'partyGST', desc: '', args: []);
  }
  ...
  /// `Usb C`
  String get usbC {
    return Intl.message('Usb C', name: 'usbC', desc: '', args: []);
  }
  ...
  /// `Pdf View`
  String get pdfView {
    return Intl.message('Pdf View', name: 'pdfView', desc: '', args: []);
  }
  ...
  /// `In Word`
  String get inWord {
    return Intl.message('In Word', name: 'inWord', desc: '', args: []);
  }
  ...
  String get returnQTY {
    return Intl.message('Return QTY', name: 'returnQTY', desc: '', args: []);
  }
  ...
  /// `Ph.no`
  String get PhNo {
    return Intl.message('Ph.no', name: 'PhNo', desc: '', args: []);
  }
  ...
  /// `KKIPAY`
  String get KKIPAY {
    return Intl.message('KKIPAY', name: 'KKIPAY', desc: '', args: []);
  }

  /// `Rezorpay`
  String get Rezorpay {
    return Intl.message('Rezorpay', name: 'Rezorpay', desc: '', args: []);
  }

  /// `SSLCommerz`
  String get SSLCommerz {
    return Intl.message('SSLCommerz', name: 'SSLCommerz', desc: '', args: []);
  }

  /// `Tap`
  String get tap {
    return Intl.message('Tap', name: 'tap', desc: '', args: []);
  }

  /// `PayStack`
  String get payStack {
    return Intl.message('PayStack', name: 'payStack', desc: '', args: []);
  }

  /// `BillPlz`
  String get BillPlz {
    return Intl.message('BillPlz', name: 'BillPlz', desc: '', args: []);
  }

  /// `Cash Free`
  String get cashFree {
    return Intl.message('Cash Free', name: 'cashFree', desc: '', args: []);
  }

  /// `Iyzico`
  String get Iyzico {
    return Intl.message('Iyzico', name: 'Iyzico', desc: '', args: []);
  }
  ...
  /// `Acton`
  String get acton {
    return Intl.message('Acton', name: 'acton', desc: '', args: []);
  }
