            ...
            child: pw.Column(
              children: [
                ...
                pw.Table.fromTextArray(
                  ...
                  data: <List<String>>[
                    <String>[
                      l.S.of(localContext).SL,
                      l.S.of(localContext).productDescription,
                      l.S.of(localContext).warranty,
                      l.S.of(localContext).quantity,
                      l.S.of(localContext).unitPirce,
                      l.S.of(localContext).price
                    ],
