...
class PurchaseReturn {
  Future<void> generatePurchaseReturnDocument(PersonalInformationModel personalInformation, PurchaseTransactionModel transactions, BuildContext context) async {
    ...
    final lang = l.S.of(localContext);
      ...
      pw.MultiPage(
                  ...
                  pw.Column(children: [
                    ...
                    pw.Row(children: [
                      ...
                      pw.SizedBox(
                        width: 125.0,
                        child: pw.Text(
                          '#${lang.returN}-${transactions.invoiceNumber}',
                          style: pw.Theme.of(context).defaultTextStyle.copyWith(color: PdfColors.black),
                        ),
                      ),
                    ]),
        ...
        footer: (pw.Context context) {
          return pw.Column(children: [
            ...
            pw.Text('${lang.poweredBy} $appName', style: const pw.TextStyle(fontSize: 10, color: PdfColors.black)),
            ...
            child: pw.Column(
              children: [
                ...
                pw.Table.fromTextArray(
                  ...
                  data: <List<String>>[
                    <String>[lang.SL, lang.productDescription, lang.warranty, lang.quantity, lang.unitPirce, lang.price],
                  ...
                  children: [
                    pw.Column(crossAxisAlignment: pw.CrossAxisAlignment.start, children: [
                      pw.Container(
                        width: 300,
                        child: pw.Text(
                          "${lang.inWord}: ${amountToWords(transactions.totalAmount!.toInt())}",
                          maxLines: 3,
    ...
    if (Platform.isIOS) {
      EasyLoading.show(status: lang.generatingPDF);
      ...
      try {
        ...
        EasyLoading.showSuccess(lang.done);
        Navigator.push(
          context,
          MaterialPageRoute(
    ...
    if (Platform.isAndroid) {
      ...
      try {
        await file.writeAsBytes(byteData.buffer.asUint8List(byteData.offsetInBytes, byteData.lengthInBytes));
        EasyLoading.showSuccess(lang.createdAndSaved);
        Navigator.push(
          context,
          MaterialPageRoute(
            builder: (context) => PDFViewerPage(path: '${dir.path}/${'Purchase_Return_${personalInformation.companyName}-${transactions.invoiceNumber}'}.pdf'),
...
Future<File> purchaseReturnPdf({required PurchaseTransactionModel transactions, required PersonalInformationModel personalInformation, required BuildContext context}) async {
  final pw.Document doc = pw.Document();
  double totalPurchaseAmount({required PurchaseTransactionModel transactions}) {
    double amount = 0;
          ...
          child: pw.Column(
            children: [
              ...
              pw.Table.fromTextArray(
                ...
                data: <List<String>>[
                  <String>[lang.SL, lang.productDescription, lang.warranty, lang.quantity, lang.unitPrice, lang.price],
                  for (int i = 0; i < transactions.productList!.length; i++)
                    <String>[
                      ('${i + 1}'),
                      ("${transactions.productList!.elementAt(i).productName.toString()}\n${transactions.productList!.elementAt(i).serialNumber.isEmpty ? '' : transactions.productList!.elementAt(i).serialNumber.toString()}"),
...
void sharePurchaseReturnPDF({required PurchaseTransactionModel transactions, required PersonalInformationModel personalInformation, required BuildContext context}) async {
